...
executefile.write('python ' + working_dir_full+ '/Secondary_radiation/scripts/compare_dchisq.py ' + cl_options + "\n")
...
jdlfilename = 'exec_concat' + '.jdl.base'
