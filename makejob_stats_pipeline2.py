...
jdlfilename = 'exec_'+number+'_' + runname+'.jdl.base'
...
jdlfile.write("Output = " + path_to_username +"/condor/"+runname+"_"+number+".out\n")
jdlfile.write("Error = "+ path_to_username+ "/condor/"+runname+"_"+number+".err\n")
