...
C     
C     Process: e- e+ > b b~ WEIGHTED<=4 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL OXXXXX(P(0,3),MDL_MB,+1,+1*IC(3),W(1,5)) ! count 8
      CALL OXXXXX(P(0,3),MDL_MB,-1,+1*IC(3),W(1,6)) ! count 8
      CALL IXXXXX(P(0,4),MDL_MB,+1,-1*IC(4),W(1,7)) ! count 8
      CALL IXXXXX(P(0,4),MDL_MB,-1,-1*IC(4),W(1,8)) ! count 8
      CALL FFV1P0_3(W(1,1),W(1,4),GC_3,ZERO, FK_ZERO,W(1,9)) ! count 4
      CALL FFV1P0_3(W(1,2),W(1,3),GC_3,ZERO, FK_ZERO,W(1,10)) ! count 4
      CALL FFV1P1N_1(W(1,5), W(1,9), GC_1, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,5), W(1,10), GC_1, TMP(1))
      call CombineAmp(2,
     & (/7,8/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,6), W(1,9), GC_1, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,6), W(1,10), GC_1, TMP(1))
      call CombineAmp(2,
     & (/5,6/), 
     & (/7,8/),
     & TMP, W, AMP(1,1)) ! count 1
      CALL FFV2_4_3(W(1,1),W(1,4),GC_50,GC_59,MDL_MZ, FK_MDL_WZ,W(1,11)) ! count 4
      CALL FFV2_4_3(W(1,2),W(1,3),GC_50,GC_59,MDL_MZ, FK_MDL_WZ,W(1,12)) ! count 4
      CALL FFV2_3P1N_1(W(1,5), W(1,11), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/7,8/),
     & TMP, W, AMP(1,2))
      CALL FFV2_3P1N_1(W(1,5), W(1,12), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/7,8/), 
     & (/7,8/),
     & TMP, W, AMP(1,2))
      CALL FFV2_3P1N_1(W(1,6), W(1,11), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/7,8/),
     & TMP, W, AMP(1,2))
      CALL FFV2_3P1N_1(W(1,6), W(1,12), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/5,6/), 
     & (/7,8/),
