...
# =============================================================================
    ...
    dchi_suffix = 'ring_starting_sample_' + str(starting_sample)+ '_numsamps_' + str(num_samples) + '_D0_' + str(D0_set_in[0]) +'_mask_thicknesses_' + '{:.2e}'.format(mask_thicknesses[0]) +'_'+ '{:.2e}'.format(mask_thicknesses[-1]) + '_sigmav_'+ 'logspace_' + str(sigmav_start) + '_' + str(sigmav_end) + '_' + str(num_sigmav) + '_mx_logspace_'+str(mx_start) + '_' + str(mx_stop) + '_' + str(num_mx) 
